...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.query.code) {
    ...
    var level;
    if (req.body && req.body['bronze']) {
        level = "http://id.incommon.org/assurance/bronze";
    } else if (req.query && req.query['bronze']) {
        level = "http://id.incommon.org/assurance/bronze";
    }
    
    if (req.body && req.body['silver']) {
        level = "http://id.incommon.org/assurance/silver";
    } else if (req.query && req.query['silver']) {
        level = "http://id.incommon.org/assurance/silver";
    }
